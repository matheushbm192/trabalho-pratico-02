...
public class Tabuleiro {
    ...
    public Tabuleiro() {
        ...
        posicoes[1] = new Lote("Leblon", 80, valores1, 0);
        posicoes[2] = new Sorte("Sorte/Revés");
        posicoes[3] = new Lote("Av. Presidente Vargas", 80, valores3, 0);
        posicoes[4] = new Lote("Av. Nossa Senhora de Copacabana", 80, valores4, 0);
        posicoes[5] = new Companhia("Companhia Ferroviária", 200, 50);
        posicoes[6] = new Lote("Av. Brigadeiro Faria Lima", 110, valores6, 0);
        posicoes[7] = new Companhia("Companhia de Viação", 200, 40);
        posicoes[8] = new Lote("Av. Rebouças", 110, valores8, 0);
        posicoes[9] = new Lote("Av. 9 de Julho", 110, valores9, 0);
        posicoes[10] = new Cadeia("Cadeia");
        posicoes[11] = new Lote("Av. Europa", 100, valores11, 0);
        posicoes[12] = new Sorte("Sorte/Revés");
        posicoes[13] = new Lote("Rua Augusta", 100, valores13, 0);
        posicoes[14] = new Lote("Av. Pacaembu", 100, valores11, 0);
        posicoes[15] = new Companhia("Companhia de Táxi", 200, 40);
        posicoes[16] = new Sorte("Sorte/Revés");
        posicoes[17] = new Lote("Interlagos", 250, valores17, 0);
        posicoes[18] = new Sorte("Lucros ou Dividendos");
        posicoes[19] = new Lote("Morumbi", 250, valores19, 0);
        posicoes[20] = new ParadaLivre("Parada Livre");
        posicoes[21] = new Lote("Bangu", 100, valores8, 0);
        posicoes[22] = new Sorte("Sorte/Revés");
        posicoes[23] = new Lote("Botafogo", 100, valores11, 0);
        posicoes[24] = new Imposto("Imposto de Renda");
        posicoes[25] = new Companhia("Companhia de Navegação", 200, 40);
        posicoes[26] = new Lote("Av. Brasil", 110, valores6, 0);
        posicoes[27] = new Sorte("Sorte/Revés");
        posicoes[28] = new Lote("Av. Paulista", 110, valores28, 0);
        posicoes[29] = new Lote("jardim Europa", 110, valores9, 0);
        posicoes[30] = new Cadeia("Vá para a Prisão");
        posicoes[31] = new Lote("Copacabana", 170, valores31, 0);
        posicoes[32] = new Companhia("Companhia de Aviação", 200, 50);
        posicoes[33] = new Lote("Av. Vieira Souto", 170, valores33, 0);
        posicoes[34] = new Lote("Av. Atlântica", 170, valores33, 0);
        posicoes[35] = new Companhia("Companhia Táxi Aéreo", 200, 50);
        posicoes[36] = new Lote("Ipanema", 170, valores36, 0);
        posicoes[37] = new Sorte("Sorte/Revés");
        posicoes[38] = new Lote("Jardim Paulista", 190, valores38, 0);
        posicoes[39] = new Lote("Brooklin", 190, valores36, 0);
